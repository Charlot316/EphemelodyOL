...
@keyframes loading-background-end-shader {
  ...
  100% { background-color: rgba(100, 100, 100, 0.2); }
}
...
.play-button {
  ...
  background-image: linear-gradient(330.9453959009229deg, rgb(252, 169, 234) 0, rgb(227, 133, 192) 6%, rgb(255, 124, 198) 53%, rgb(243, 83, 113) 100%);
  transition: 0.5s;
}
.play-button:hover {
  transform: scale(0.9);
