...
const rules = {
  ...
  startColor: [{ required: true, message: "请选择颜色", trigger: "blur" }],
...
const updateTemp = () => {
  ...
  tempOperation.startColor = `rgb(${props.operation.startR},${props.operation.startG},${props.operation.startB})`;
  tempOperation.endColor = `rgb(${props.operation.endR},${props.operation.endG},${props.operation.endB})`;
};
